...
<div class="container_10">
    ...
    <div class="box">
        <h2>
            <a href="#" id="toggle-list">Lista de Asignaciones <?php echo $_SESSION['USER_APELLIDO'].' '.$_SESSION['USER_NOMBRE']; ?></a>
        </h2>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                ...
                <?php foreach ($view->asignacion as $asig) {?>
                    <tr class="odd gradeA">
                        ...
                        <td class="center"><a href="#" title="Evaluación" class="evaluacion_link" id="<?php  echo $asig["ID_ASIGNACION"];  ?>"><img src="public/img/tests-icon.png" width="15px" height="15px"></a></td>
                    </tr>
                <?php }  ?>
