            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                ...
                <?php foreach ($view->asignacion as $asig) {?>
                    <tr class="odd gradeA">
                        ...
                        <td class="center"><a href="#" title="Comunicación" class="<?php echo ($asig["NRO_ORDEN"] < 3)? 'link-desactivado' : 'comunicacion_link' ?>" id="<?php  echo $asig["ID_ASIGNACION"];  ?>"><img src="public/img/Communication-icon.png" width="15px" height="15px"></a></td>
                        <td class="center"><a href="#" title="Evaluación" class="<?php echo ($asig["NRO_ORDEN"] < 4)? 'link-desactivado' : 'evaluacion_link' ?>" id="<?php  echo $asig["ID_ASIGNACION"];  ?>"><img src="public/img/tests-icon.png" width="15px" height="15px"></a></td>
                        <td class="center"><a href="#" title="Post Evaluación" class="<?php echo ($asig["NRO_ORDEN"] < 5)? 'link-desactivado' : 'evaluacion_link' ?>" id="<?php  echo $asig["ID_ASIGNACION"];  ?>"><img src="public/img/tests-icon.png" width="15px" height="15px"></a></td>
                    </tr>
                <?php }  ?>
